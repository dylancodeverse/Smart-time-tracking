...
import 'package:sola/clean/domain/service/interface/i_daily_statistic_list_service.dart';
  ...
  Future<List<DailyStatistic>> filterByBusName(String busName) async {
    try {
      ...
      return allStatistics
          .where((statistic) => statistic.assignment.bus.registrationNumber == busName)
          .toList();
    } catch (e) {
      // Gestion d'erreur
